...
- (id )registerUncancellableClientWithName:(NSString *)arg1;
- (id )registerClientWithName:(NSString *)arg1 promptForCancellation:(BOOL)arg2 cancellationBlock:(void (^)(void))arg3;
@end
