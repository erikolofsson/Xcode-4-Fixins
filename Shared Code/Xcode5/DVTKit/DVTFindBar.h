...
@class DVTBorderedView, DVTFindBarOptionsCtrl, DVTFindPatternTextField, DVTLogAspect, DVTObservingToken, DVTSearchField, DVTSharedFindState, DVTStackView_ML, NSAttributedString, NSMutableArray, NSObject, NSPopUpButton, NSSegmentedControl, NSString, NSTextField, NSTimer, NSView;
...
@property(retain) NSObject *delegate; // @synthesize delegate=_delegate;
