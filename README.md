__These plugins are only maintained for the latest version of Xcode (currently 8.3)__
...
__===== INSTALLATION (Xcode 8.3) =====__

Despite the name, the Xcode 4 Fixins are compatible with Xcode 8.3.
