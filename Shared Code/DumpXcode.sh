...
for Executable in $XcodeExecutables; do
	...
	class-dump -H --sdk-mac /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -o $CurrentPath/XcodeDump "$Executable"
