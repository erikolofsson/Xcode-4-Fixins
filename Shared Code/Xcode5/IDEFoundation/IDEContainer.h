...
#import "../DVTKit/DVTModelObject.h"

#import "../DVTKit/DVTDirectoryBasedCustomDataStoreDelegate-Protocol.h"
...
@interface IDEContainer : DVTModelObject <DVTInvalidation, IDEIntegrityLogDataSource, IDEReadOnlyItem, DVTDirectoryBasedCustomDataStoreDelegate, IDEUpgradeableItem>
{
    ...
    id _resolvePendingFilesCancellableToken;
    int _activity;
...
@property(readonly) id containerCore; // @synthesize containerCore=_containerCore;
@property(retain) id containerDelegate; // @synthesize containerDelegate=_containerDelegate;
