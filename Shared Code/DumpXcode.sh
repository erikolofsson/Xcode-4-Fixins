...
#	echo $Executable 1>&2
	...
	/Source/class-dump/build/Release/class-dump -H -F --sdk-mac /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -o $CurrentPath/XcodeDump "$Executable"
